<%-- 
    Document   : dashboard
    Created on : Jul 8, 2018, 5:37:27 PM
    Author     : freedom.c
--%>
    ...
    -->
      <div class="logo">
        <a href="dashboard.jsp" class="simple-text logo-normal">
            <img src="../bootstrap/image/logos/bulkit-w.png" alt="" width="100">
        </a>
      </div>
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <p class="card-category">No of Registered Farmers</p>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <p class="card-category">Farm Sector</p>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <p class="card-category">All farmers Community</p>
                  <h3 class="card-title">0</h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 class="card-title">Daily Problem Solve</h4>
            ...
            <div class="col-md-4">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 class="card-title">Loan  Given monthly</h4>
            ...
            <div class="col-md-4">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 class="card-title">Complain Record</h4>
                  <p class="card-category">Last Campaign Performance</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
          ...
          <div class="row">
                      ...
                      <ul class="nav nav-tabs" data-tabs="tabs">
                        <li class="nav-item">
                          <a class="nav-link active" href="#profile" data-toggle="tab">
                            <i class="material-icons">account_balance</i> Grant loan
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="#messages" data-toggle="tab">
                            <i class="material-icons">announcement</i> Reply
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="#settings" data-toggle="tab">
                            <i class="material-icons">work</i> Meetings
                            <div class="ripple-container"></div>
                          </a>
                        </li>
                      </ul>
            ...
            <div class="col-lg-6 col-md-12">
              <div class="card">
                <div class="card-header card-header-warning">
                  <h4 class="card-title">Farmers Stats</h4>
                  <p class="card-category">New Farmers from <%= new java.util.Date()%></p>
                </div>
